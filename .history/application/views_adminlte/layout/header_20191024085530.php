                ...
                <ul class="dropdown-menu menu">
                    ...
                    <?php if ($this->datab->is_admin()) : ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    <?php if ($this->apilib->isCacheEnabled()) : ?>
                                        <a href="<?php echo base_url('main/cache_control/off'); ?>"><i class="fas fa-cogs"></i> Disabilita cache</a>
                                    <?php else : ?>
                                        <a href="<?php echo base_url('main/cache_control/on'); ?>"><i class="fas fa-cogs"></i> Ri-abilita cache</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    <a href="<?php echo base_url('main/cache_control/clear'); ?>"><i class="fas fa-trash-alt"></i> Pulisci cache</a>
                                </div>
                            </div>
                        </li>
