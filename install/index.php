                ...
                <div id="smartwizard" style="border-top:3px solid #005977 ;border-radius:3px;">
                    ...
                    <div>
                        ...
                        <div id="db-setup" class="">
                            <!-- <p>In this step, you have to enter your database details<br />Database and User must be created BEFORE insterting here, otherwise connection will fail and your <b>Fire</b>GUI Client database cannot be imported.</p> -->
