...
if (isset($grid_data['data'])) {
    foreach ($grid_data['data'] as $x => $dato) {
        ...
        $items[$dato[$grid_data['entity']['entity_name']."_id"]] = array(
                'thumb' => isset($grid['replaces']['thumbnail'])? $this->datab->build_grid_cell($grid['replaces']['thumbnail'], $dato): null,
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
    ...
    <div class="dashboard-stat blue big-tile-list-item">
        <a href="<?php echo (empty($grid['grids']['links']['view'])? 'javascript:void(0);': $grid['grids']['links']['view'] . $id) ?>">
            ...
            <div class="details">
                <div class="number" style="font-size: 24px;"><?php echo $item['nome']; ?></div>
                <div class="desc" style="font-size: 14px;">Demo prevista: <?php echo $item['consegnaDemo']; ?></div>
                <div class="desc" style="font-size: 14px;">Consegna prevista: <?php echo $item['consegna']; ?></div>
            </div>
