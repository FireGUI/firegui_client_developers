<table class="table table-striped table-bordered table-condensed table-hover table-responsive-scrollable js_datatable_slim" <?php if($grid['grids']['grids_order_by']) echo 'data-prevent-order' ?> id="grid_<?php echo $grid['grids']['grids_id'] ?>">
    <thead>
        <tr>
