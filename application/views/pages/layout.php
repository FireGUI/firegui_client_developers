                ...
                <div class="<?php echo sprintf('col-lg-%s', $layout['layouts_boxes_cols']); ?>" data-layout-box="<?php echo $layout['layouts_boxes_id']; ?>">
                    ...
                    <div class="<?php echo implode(' ', $classes); ?>">
                        <?php if($layout['layouts_boxes_titolable'] === 't'): ?>
                            <div class="portlet-title <?php echo ($layout['layouts_boxes_collapsible'] === 't') ? 'js_title_collapse' : ''; ?>">
                                <div class="caption">
                                ...
                                <div class="tools">
                                    <?php if ($layout['layouts_boxes_collapsible'] === 't'): ?><a href="javascript:;" class="<?php echo ($layout['layouts_boxes_collapsed']=='t')? 'expand': 'collapse'; ?>"></a><?php endif; ?>
                                    <?php if ($layout['layouts_boxes_discardable'] === 't'): ?><a href="javascript:;" class="remove"></a><?php endif; ?>
                                    <?php if ($layout['layouts_boxes_reloadable'] === 't'): ?><a href="javascript:;" class="reload"></a><?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        
                        <div class="portlet-body <?php echo $layout['layouts_boxes_content_type'] ?> <?php echo ($layout['layouts_boxes_collapsible']=='t' && $layout['layouts_boxes_collapsed']=='t') ? 'display-hide' : ''; ?>">
