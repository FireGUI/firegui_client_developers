...
<form <?php echo "id='{$form_id}'"; ?> role="form" method="post" action="<?php echo $form['forms']['action_url']; ?>"
    class="formAjax <?php echo ($form['forms']['forms_css_extra']) ?? null; ?>" enctype="multipart/form-data"
    data-edit-id="<?php echo $value_id; ?>">
    <?php add_csrf(); ?>
    <!-- FORM HIDDEN DATA -->
    ...
    <div class="box-body">
        <div class="row sortableForm">
            <?php foreach ($form['forms_fields'] as $k => $field): ?>
                ...
                <div data-form_id="<?php echo $form['forms']['forms_id']; ?>"
                    class="formColumn js_container_field <?php echo sprintf('col-md-%d', $field['size']); ?>"
