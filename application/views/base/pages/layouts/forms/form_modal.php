                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form <?php echo "id='{$form_id}'"; ?> role="form" method="post"
                                ...
                                enctype="multipart/form-data" <?php if (!is_array($value_id)): ?>data-edit-id="<?php echo $value_id; ?>" <?php else: ?>data-edit-id="" <?php endif; ?>>
                                <?php add_csrf(); ?>
                                <?php if ($bulk_mode): ?>
                                ...
                                <div class="form-body">
                                                        ...
                                                        <div class="js_field_container">
                                                            ...
                                                            <?php else: ?>
                                                                <div id="<?php echo $field['id']; ?>"
                                                                    ...
                                                                    data-cols="<?php echo $field['size']; ?>">

                                                                    <!-- Builder buttons -->
                                                                    <div class="builder_formcolumns_buttons hide">
                                                                        <a href="javascript:void(0);"
                                                                            class="btn btn-box-tool js_btn_fields_minus"
                                                                            data-toggle="tooltip" data-original-title="- columns">
                                                                            <i class="fas fa-caret-left"></i>
                                                                        </a>
                                                                        Size
                                                                        <a href="javascript:void(0);"
                                                                            class="btn btn-box-tool js_btn_fields_plus"
                                                                            data-toggle="tooltip" data-original-title="+ columns">
                                                                        ...
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            data-toggle="tooltip"
                                                                            data-original-title="Remove field">
                                    ...
                                    <div class="form-actions">
                                            ...
                                            <div class="pull-left">
                                                ...
                                                <?php if ($show_delete_button): ?>
                                                    <a href="<?php echo base_url("db_ajax/generic_delete/{$form['forms']['entity_name']}/$value_id"); ?>"
                                                        ...
                                                        class="btn btn-danger js_confirm_button js_link_ajax "
                                                        data-toggle="tooltip" title="" data-original-title="Elimina">
                                                        <?php e('Delete'); ?>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary"><?php echo (array_key_exists('forms_submit_button_label', $form['forms']) && !empty($form['forms']['forms_submit_button_label'])) ? $form['forms']['forms_submit_button_label'] : t('Save'); ?></button>
                                        </div>
                                    </div>
                                </div>
