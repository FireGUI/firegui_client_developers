...
// Filtra tutti i valori array e oggetto dall'array dati
        ...
        $replace_to[] = $id;
        $dropdownExists = array_search('dropdown', array_column($links['custom'], 'grids_actions_show')) !== false;
        $dropdownCount = 0;
        ...
        if ($dropdownExists) {
            ...
            foreach ($links['custom'] as $link) {
                if ($link['grids_actions_show'] === 'dropdown') {
                    $dropdownLinks[] = $link;
                    $dropdownCount++;
                } else {
                    $sortedLinks[] = $link;
            ...
            // Unisci gli elementi con dropdown all'inizio dell'array
            $links['custom'] = array_merge($dropdownLinks, $sortedLinks);
        }
        ...
        <?php foreach ($links['custom'] as $custom_action): ?>
            ...
            ?>
            <?php
            if($custom_action['grids_actions_show'] == 'dropdown' AND $count_dropdown_show == 0){
            ...
            if($custom_action['grids_actions_show'] == 'dropdown'){
                $count_dropdown_show++;             
            }
            ?>
            ...
            <?php endif; ?>
            <?php
            if($custom_action['grids_actions_show'] == 'dropdown' AND $count_dropdown_show == $dropdownCount){
                echo "</ul>";
                echo "</div>";
            }
            ?>
