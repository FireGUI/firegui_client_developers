...
<div class="<?php echo $class ?>">
    ...
    <input type="hidden" class="default" id="js_field_<?php echo $field['fields_id']; ?>" name="<?php echo $field['fields_name']; ?>" value="<?php echo $value; ?>" data-dependent_on="<?php echo $field['forms_fields_dependent_on']; ?>" />
