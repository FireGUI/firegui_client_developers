            ...
            <div class="row js_multiple_key_values_row" style="margin-top:10px">
                ...
                <div class="col-xs-1 text-center" style="padding-top:5px">
                    <label class="container-checkbox ">
                        <input type="checkbox" value="<?php echo DB_BOOL_TRUE; ?>" class="js_container-checkbox" name="<?php echo $field['fields_name']; ?>[<?php echo $count; ?>][checked]" <?php if ($single_value['checked'] == DB_BOOL_TRUE) : ?>checked="checked" <?php endif; ?> data-dependent_on="<?php echo $field['forms_fields_dependent_on']; ?>"  />
