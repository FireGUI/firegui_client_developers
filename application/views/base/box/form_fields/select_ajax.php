...
<select class="js_select_ajax_new form-control <?php echo $class ?>" name="<?php echo $field['fields_name']; ?>" value="<?php echo $value; ?>" data-required="<?php echo $field['fields_required'] ?>" data-source-field="<?php echo $field['fields_source'] ?>" data-ref="<?php echo $field['fields_ref'] ?>" data-val="<?php echo $value; ?>" <?php echo $attr; ?> data-dependent_on="<?php echo $field['forms_fields_dependent_on']; ?>" >
