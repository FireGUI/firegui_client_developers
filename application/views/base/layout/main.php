...
<body class="hold-transition skin-blue sidebar-mini" data-csrf="<?php echo base64_encode(json_encode(get_csrf())); ?>"
    data-base_url="<?php echo base_url(); ?>" data-base_url_admin="<?php echo base_url_admin(); ?>"
    data-base_url_template="<?php echo base_url_template(); ?>"
    ...
    <div class="wrapper">
        ...
        <div id="js_layout_content_wrapper" class="content-wrapper"
            ...
            <?php if (is_maintenance()): ?>
                <section class="content-header">
                    <div class="callout callout-warning">
                        <h4>
                            <?php e('Updates in progress'); ?>
                        </h4>

                        <p>
                            <?php e('Dear customer, we are making updates to your platform, the service may be subject to slight interruptions, we apologize for the inconvenience.'); ?>
                        </p>
                    </div>
                </section>
            <?php endif; ?>
            ...
            <div class="js_page_content"
                ...
                data-title="<?php echo (!empty($dati['title_prefix'])) ? $dati['title_prefix'] : ''; ?>"
                data-related_entities="<?php echo (!empty($dati['related_entities'])) ? implode(',', $dati['related_entities']) : ''; ?>">
                <?php echo $page; ?>
            </div>
        </div>
        <?php echo $footer; ?>
