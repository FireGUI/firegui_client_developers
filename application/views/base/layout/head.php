...
<!-- SWEETALERT2 -->
<link rel="stylesheet" href="<?php echo base_url_template("script/lib/sweetalert2/sweetalert2.min.css?v=" . VERSION); ?>"/>

<!-- TOASTR -->
<link rel="stylesheet" href="<?php echo base_url_template("script/lib/toastr/toastr.min.css?v=" . VERSION); ?>"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url_template("template/adminlte_custom/base_components.css?v=" . VERSION); ?>"/>
...
<?php $this->layout->addDinamicJavascript([//"var base_url = '" . base_url() . "';",
    ...
    "var lang_code = '" . ((!empty($lang['languages_code'])) ? $lang['languages_code'] : 'en-EN') . "';", "var builderProjectHash = '" . base64_encode(json_encode([$this->db->database, $this->db->hostname, $this->db->username, md5($this->db->password)])) . "';", "var lang_short_code = '" . ((!empty($lang['languages_code'])) ? (explode('-', $lang['languages_code'])[0]) : 'en') . "';",], 'config.js'); ?>
