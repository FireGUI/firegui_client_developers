...
<title>
    <?php echo ucwords(htmlspecialchars(trim(implode(' - ', array_filter([$tprefix, $title, $tsuffix]))))); ?>
</title>
...
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/bower_components/bootstrap/dist/css/bootstrap.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/bower_components/@fortawesome/fontawesome-free/css/all.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/bower_components/bootstrap/dist/css/bootstrap.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/bower_components/Ionicons/css/ionicons.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("template/adminlte/bower_components/select2/dist/css/select2.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/global/css/components-md.css.map?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/lib/bootstrap-colorselector/dist/bootstrap-colorselector.min.css"); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template('template/adminlte/dist/css/jquery-ui.min.css'); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template('template/adminlte/dist/css/jquery-ui.theme.css'); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/dist/css/AdminLTE.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte/dist/css/skins/_all-skins.min.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/lib/lightbox2/css/lightbox.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet"
    href="<?php echo base_url_scripts("script/lib/leaflet-1.7.1/Leaflet.draw/src/leaflet.draw.css?v=" . VERSION); ?>" />
<link rel="stylesheet"
    href="<?php echo base_url_scripts("script/lib/leaflet-fullscreen/leaflet.fullscreen.css?v=" . VERSION); ?>" />

<link rel="stylesheet"
    href="<?php echo base_url_template("script/lib/Leaflet.markercluster/dist/MarkerCluster.css?v=" . VERSION); ?>" />
<link rel="stylesheet"
    href="<?php echo base_url_template("script/lib/Leaflet.markercluster/dist/MarkerCluster.Default.css?v=" . VERSION); ?>" />
...
<!-- CUSTOM CSS -->
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_template("template/adminlte_custom/custom.css?v=" . VERSION); ?>" />
<link rel="stylesheet" type="text/css"
...
<script
    src="<?php echo base_url_template("template/adminlte/bower_components/jquery/dist/jquery.min.js?v=" . VERSION); ?>"></script>
...
<script
    src="<?php echo base_url_scripts("script/lib/highcharts-3.0.9/js/modules/exporting.js?v=" . VERSION); ?>"></script>
<script src="<?php echo base_url_scripts("script/lib/highcharts-3.0.9/js/modules/funnel.js?v=" . VERSION); ?>"></script>
<script
    src="<?php echo base_url_scripts("script/lib/highcharts-3.0.9/js/highcharts_options.js?v=" . VERSION); ?>"></script>
<script src="<?php echo base_url_scripts("script/lib/chart.js-2.9.3/dist/Chart.js?v=" . VERSION); ?>"></script>
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/lib/chart.js-2.9.3/dist/Chart.css?v=" . VERSION); ?>" />
<script
    src="<?php echo base_url_scripts("script/lib/apexcharts-bundle/dist/apexcharts.min.js?v=" . VERSION); ?>"></script>
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url_scripts("script/lib/apexcharts-bundle/dist/apexcharts.css?v=" . VERSION); ?>" />
