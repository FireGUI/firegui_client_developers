<?php $is_administrator = (isset($dati['permissions']['permissions_admin']) AND $dati['permissions']['permissions_admin'] === 't'); ?>

<?php if(!empty($dati['groups']) && $dati['is_user_permissions']): ?>
    ...
    <br/>
<?php elseif($dati['is_create_group']): ?>
...
<div id="all-permissions">
    ...
    <div class="col-md-9">
        <label class="radio-inline">
            <input type="radio" name="permissions_admin" value="f" class="toggle permission_toggle" <?php if (!$is_administrator) echo 'checked'; ?>  />
            <?php e("no"); ?>
        </label>
        <label class="radio-inline">
            <input type="radio" name="permissions_admin" value="t" class="toggle permission_toggle" <?php if ($is_administrator) echo 'checked'; ?>  />
            <?php e("si"); ?>
        </label>
    </div>
...
<?php if($dati['is_user_permissions']): ?>
