...
<div class="clearfix">
    <div class="input-intrange-wrapper">
        Min: <input type="number" step="1"  class="form-control input-sm <?php echo $class ?>" value="<?php echo $value['from']; ?> js_int_range_<?php echo $field['fields_id']; ?>_from" <?php echo $onclick; ?> />
    </div>
    <div class="input-intrange-wrapper">
        Max: <input type="number" step="1"  class="form-control input-sm <?php echo $class ?> js_int_range_<?php echo $field['fields_id']; ?>_to" value="<?php echo $value['to']; ?>" <?php echo $onclick; ?> />
    </div>
</div>
<?php echo $help; ?>
