 ...
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * 
 * RICORDARSI DI NON MODIFICARE QUESTO FILE MA AGGIUNGERE IL
 * 
 * FILE EMAIL_CUSTOM.PHP E SOVRASCRIVERE LI I PARAMETRI
 * 
 **********************************************************/
...
if (file_exists(APPPATH.'./config/email_custom.php')) {
    include_once APPPATH.'./config/email_custom.php';
}