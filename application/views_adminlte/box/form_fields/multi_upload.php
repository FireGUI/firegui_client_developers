            ...
            <?php
                ...
                if (@json_decode($value)) {
                    ...
                    foreach ($files as $key => $file) : //debug($file,true);?>
                        ...
                        var mockFile = { name: "<?php echo $file->client_name; ?>", key: <?php echo $key; ?>, size: <?php echo $file->file_size; ?>, id: '<?php echo "{$field['forms_fields_fields_id']}/"; ?>'+$(form_selector).data('edit-id')+'<?php echo "/{$key}"; ?>', url: "<?php echo base_url_uploads('uploads/'.$file->path_local); ?>" };
                    ...
                    foreach ($files as $file_id => $file) : ?>
                        <?php if (empty($field['field_support_id'])) {continue;} ?>
                        // Create the mock file:
                        var mockFile = { name: "Allegato <?php echo $key+1; ?>", intid: <?php echo $file_id; ?>, size: 1000000, id: '<?php echo "{$field['field_support_id']}/{$field['fields_id']}/{$file_id}"; ?>', url: "<?php echo base_url_uploads('uploads/'.$file); ?>" };
