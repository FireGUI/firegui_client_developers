<div class="col-md-<?php echo $cols; ?>">
    <div class="btn-group pull-right">
        <button type="button" class="btn btn-fit-height pull-right grey dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true" aria-expanded="false">
