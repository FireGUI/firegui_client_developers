        ...
        <thead>
            <tr>
                ...
                <?php foreach ($grid['grids_fields'] as $field) : ?>
                    ...
                    <th data-name="<?php echo $name; ?>" <?php if ($field['fields_draw_html_type'] === 'upload_image') echo ' style="width:50px;"'; ?><?php echo ($field['grids_fields_replace_type'] !== 'field' && !$field['grids_fields_eval_cache_data']) ? ' data-prevent-order ' : ''; ?>><?php e($field['grids_fields_column_name']);  ?></th>
