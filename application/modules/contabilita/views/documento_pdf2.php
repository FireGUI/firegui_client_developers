...
$id = $this->input->get("documento_id");
if (!$id) {
    die("Documento non valido o non più disponibile");
}
...
<div class="big_table">
    <div class="container">
        <div class="row small-margin">
            ...
            <div class="col-md-3 fattura" style="background-color: #dd4b39;">
                <div class="blu1">
                    <h1 style="margin-top: 10px;"><?php echo strtoupper($documento['documenti_tipo_value']); ?></h1>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-sm-4 mittente1">
                    ...
                    <div class="" style="float: left;">
                        <div>
                            <strong style="color: #dd4b39;"><?php echo $settings['settings_company_name']; ?></strong>
                        </div>
                ...
                <div class="col-sm-4 destinatario">
                    ...
                    <div>
                        <strong style="color: #dd4b39;"><?php echo $destinatario['ragione_sociale']; ?></strong>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="document">
                        ...
                        <strong>Documento: </strong><br><strong
                                style="color: #dd4b39;">nr. <?php echo $documento['documenti_numero']; ?> <?php echo ($documento['documenti_numero']) ? '/' . $documento['documenti_serie'] : ''; ?>
                            del <?php echo date('d-m-Y', strtotime($documento['documenti_data_emissione'])); ?></strong>
                        <!--                        </div>-->
                    </div>
                </div>
            ...
            <div class="row" style="display:none">
                <div class="col-md-3 PayPal">
                    <strong style="color: #dd4b39;">Paga con PayPal</strong> <img src="../../../metodi-di-pagamento.png"
                                                                                  alt="" class="paypal_img"/>
                </div>
            </div>
            ...
            <br><br>
            <div class="services">
                <?php echo $documento['documenti_note_interne']; ?>
            </div>
