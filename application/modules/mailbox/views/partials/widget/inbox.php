    ...
    <thead>
        <tr>
            ...
            <th class="pagination-control" colspan="3">
                ...
                <a class="btn btn-sm blue" data-current="<?php echo $data['current']; ?>" data-page="<?php echo $data['prev']; ?>"><i class="icon-angle-left"></i></a>
                <a class="btn btn-sm blue" data-current="<?php echo $data['current']; ?>" data-page="<?php echo $data['next']; ?>"><i class="icon-angle-right"></i></a>
            </th>
        </tr>
    </thead>
    <tbody>
