        ...
        <table class="table js-installed_modules_table">
            ...
            <tbody>
                ...
                <?php foreach ($installed_modules as $module): ?>
                    <tr data-module_identifier="<?php echo ($module['modules_identifier']); ?>"
                        data-module_version_code="<?php echo $module['modules_version_code']; ?>">
                        <td>
                        ...
                        <td>
                            <a href="<?php echo base_url('module-manager/main/show_details/' . $module['modules_identifier']); ?>"
                                class="js_open_modal"><?php echo ($module['modules_version']); ?></a><br />
                        ...
                        <td>
                            <div class="material-switch">
                                <span
                                    style="display:none"><?php echo ($module['modules_auto_update'] == DB_BOOL_TRUE) ? t('Yes') : t('No'); ?></span>

                                <input class="js-switch_auto_update" data-modules_id="<?php echo $module['modules_id']; ?>"
                                    value="<?php echo DB_BOOL_TRUE; ?>" id="switch_bool<?php echo $module['modules_id']; ?>"
                                    name="someSwitchOption001" type="checkbox" <?php if ($module['modules_auto_update'] == DB_BOOL_TRUE): ?> checked="checked" <?php endif; ?> />
                        ...
                        <td>
                            ...
                            <button class="btn btn-grey js-module_check_now"
                                data-module_identifier="<?php echo $module['modules_identifier']; ?>"><span>Check
                                    now</span></button>
                            <button class="btn btn-warning js-module_update"
                                data-module_identifier="<?php echo $module['modules_identifier']; ?>"
                                style="display:none;">Update</button>
                            <button class="btn btn-success js-module_already_updated"
                                style="display:none;cursor:not-allowed;">Up to date!</button>
                        </td>
