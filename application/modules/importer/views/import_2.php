                                        ...
                                        <?php foreach ($dati['csv_head'] as $k=>$field): ?>
                                            <?php if ($field): ?>
                                                <th class="text-center">
                                                    <?php echo $field; ?><?php if ($dati['import_data']['action_on_data_present'] == 2 || $dati['import_data']['action_on_data_present'] == 4): ?> (<input style="margin-left:0px;" type="radio" name="unique_key" value="<?php echo $k; ?>" /> chiave per update)<?php endif; ?>
                                                    <br/>
