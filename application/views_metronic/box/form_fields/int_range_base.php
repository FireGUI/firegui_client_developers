...
<div class="clearfix">
    <div class="input-intrange-wrapper">
        Min: <input type="number" step="1" id="int_range_<?php echo $field['fields_id']; ?>_from" class="form-control input-sm <?php echo $class ?>" value="<?php echo $value['from']; ?>" <?php echo $onclick; ?> />
    </div>
    <div class="input-intrange-wrapper">
        Max: <input type="number" step="1" id="int_range_<?php echo $field['fields_id']; ?>_to" class="form-control input-sm <?php echo $class ?>" value="<?php echo $value['to']; ?>" <?php echo $onclick; ?> />
    </div>
</div>
<?php echo $help; ?>
