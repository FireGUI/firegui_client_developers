    ...
    $(function () {
        ...
        if (jqCalendar.width() <= 400) {
            ...
            h = {
                ...
                center: '',
                right: 'today,month,agendaWeek,agendaBusinessWeek,agendaDay'
            };
        } else {
            ...
            if (Metronic.isRTL()) {
                ...
                h = {
                    left: 'title',
                    center: '',
                    right: 'prev,next,today,month,agendaWeek,agendaBusinessWeek,agendaDay'
                };
            }
        }
...
//            locale: 'it',
            ...
            timeFormat: 'H:mm',
            columnFormat: {agendaWeek: 'ddd D MMMM'},
            axisFormat: 'H:mm',
            minTime: minTime,
            maxTime: maxTime,
